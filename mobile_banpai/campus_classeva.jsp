...
<html>
	...
	<body style="background: #fff;">
		<div class="content">
			...
			<!--班级在校排名-->
			<div class="div">
				<p class="titCenter">班级在校排名</p>
				<table  class="divtab"  id="tab1">
					<tr><th>上周评比<br>总分/名次</th><th>目前排名</th><th>上周排名</th><th>上月排名</th></tr>
					<tr><td id="week_total"></td><td id="rangeno"></td><td id="week_range"></td><td id="month_range"></td></tr>
				</table>
			</div>
			
			<!--项目评比-->
			<div class="div">
				<p class="titCenter">项目评比</p>
				<table class="divtab">
					<tr id="item"><th>星期/项目</th><th>卫生</th><th>出勤</th><th>早操</th><th>校规</th><th>个人面貌</th><th>统计</th></tr>
					<tbody id="weektable">
		...
		<!--底部导航-->
		<script type="text/javascript" src="js/campus_classeva.js"></script>
	</body>
</html>
