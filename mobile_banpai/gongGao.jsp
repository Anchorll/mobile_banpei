...
<html>
	<head>
		...
		<title>电子班牌-公告信息</title>
		<link rel="stylesheet" type="text/css" href="css/c_common.css"/>
		<link rel="stylesheet" type="text/css" href="css/common_list.css"/>
	...
	<body>
		<div class="content">
			...
			<ul class="dateul">
				...
				<li>30天</li>
				<li>90天</li>
				<!--<li style="position: relative;">自定义<label></label>
				</li>-->
				<li style="position: relative;">全部</li>
				<!--<li>
					<input type="date" style="width: 100%;height: 100%;top: 0px;left: 0px;"/>
				</li>-->
			</ul>
		...
		<div class="banner">
			<div class="bdiv">
				<ul id="ulimg" style="background:#f1faff">
					
				</ul>
			</div>
			<a id="leftear"><img src="img/pprev2.png"/></a>
			<a id="rightear"><img src="img/pnext2.png"/></a>
		</div>
		...
		<footer class="footer" id="footer"><ul>
			...
			<li><a><img src="img/gonggaod.png"/><span style="color: #3CACFE;">公告信息</span></a></li>
		</ul></footer>
		<!--底部导航-->
