	...
	<body>
		<div class="content">
			...
			<div class="subjectDiv">
				<ul class="subject" id="subject">
				</ul>
				
				<a id="lear" class="ea"></a>
				<a id="rear" class="ea"></a>
		...
		<!--底部导航-->
		<script type="text/javascript" src="js/myhomeWork.js"></script>
	</body>
</html>
